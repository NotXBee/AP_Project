...
public class MainGameScreen2 implements Screen, Serializable {
    ...
    public void show() {
        if (c) {
            ...
            // Create pigs
            pigs = new ArrayList<>();
            pigs.add(new Pig(world, "pigHelmet.png", new Vector2(785, 160), 70, 70, 5000)); // First pig
            pigs.add(new Pig(world, "pigPig.png", new Vector2(785, 305), 50, 50, 3000)); // Second pig
        }
    }
    ...
    public static MainGameScreen2 loadState(String filePath, AngryBirds game) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(filePath))) {
            MainGameScreen2 screen = (MainGameScreen2) ois.readObject();
