...
public class MainGameScreen3 implements Screen, Serializable {
    ...
    public void show() {
        if (c) {
            ...
            pigs.add(new Pig(world, "pigKing.png", new Vector2(865, 160), 62, 62, 4000));
            pigs.add(new Pig(world, "pigHelmet.png", new Vector2(715, 160), 70, 70, 5000));
        }
    }
    ...
    public void render(float delta) {
        ...
        float birdSize = 70f; // Adjust this value to match the bird's radius
